...
- A sample, on the other hand, is a subset of the population that is selected for data analysis.
...
- Parameters are numerical values that describe specific characteristics of a population or a probability distribution.
- They provide important information about the population's central tendency, variability, and shape.
- Examples of parameters include the population mean, population variance, and population proportion. Parameters are often denoted using Greek letters and are typically unknown, requiring estimation from sample data.

Statistics:

- Statistics are numerical values calculated from a sample of data and are used to make inferences about population parameters.
- Common statistics include the sample mean, sample variance, and sample proportion. These values provide insights into the characteristics of the data at hand and can be used to estimate population parameters.
- Statistics are denoted using regular letters and are used to draw conclusions about the larger population based on the information available in the sample.

In summary, parameters are characteristics of a population or distribution, while statistics are derived from sample data and provide insights into the underlying population parameters.
...
2. Categorical Data:
    ...
    2. Nominal Data:
        - Nominal data represents categories with no order or ranking.
